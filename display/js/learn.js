(function() {
    ...
    function displayQuiz(quizName) {
        ...
        const backButton = document.getElementById("next-btnq");
        ...
        function selectAnswer(e) {
            ...
            const gifTrue = document.querySelector(".Gif_true");
            const gifFalse = document.querySelector(".Gif_false");

            if (isCorrect) {
                selectedBtn.classList.add("correct");
                score++;
                gif.style.display = "none";
                gifTrue.style.display = "block";
            } else {
                selectedBtn.classList.add("incorrect");
                gif.style.display = "none";
                gifFalse.style.display = "block";
            }
            ...
            // Hide GIFs after 4 seconds and show the default GIF
            setTimeout(() => {
                gifTrue.style.display = "none";
                gifFalse.style.display = "none";
        ...
        function showScore() {
            ...
            quizContent.innerHTML = `
                <div class="kq_quiz">
                    <div class="img_kq">
                        <img loading="lazy" decoding="async" src="http://www.cartoonbrew.com/wp-content/uploads/2022/10/duolingo_lesson_end.gif" alt="Duolingo Lesson End" width="275" height="300" class="alignnone size-full wp-image-221893">
                    </div>
                    <div class="text_quiz">
                    ...
                    <div class="diem_quiz">
                        <div class="box_diem">
                            <div class="title_diem">
                                <p>SỐ CÂU ĐÚNG</p>
                            </div>
                            <div class="text_diem">
                                <img src="assets/learn/icons8-approved-checkmark-symbol-to-verify-the-result-28.png" alt="">
                                <h1 id="score">${score}</h1>
                            </div>
                        </div>
                        <div class="box_diem" id="diem1">
                            <div class="title_diem">
                                <p>TỔNG</p>
                            </div>
                            <div class="text_diem">
                                <img class="_1F1Qc" src="https://d35aaqx5ub95lt.cloudfront.net/images/icons/9ace13520a375f5661415ff7d470f243.svg">
                                <h1 id="total-questions">${questions.length}</h1>
                            </div>
                        </div>
                    </div>
                    <hr>
                    <div id="buttonq-container">
                  
                        <button id="exit-btnq" class="buttons">TIẾP TỤC</button>
                    </div>
                </div>
            `;


            const continueButton = document.getElementById("exit-btnq");



            if (continueButton) {
                continueButton.addEventListener("click", () => {
                    toggleDisplay('.page', '#quizContent');
                });
            }
        ...
        function updateTimer() {
            ...
            if (timeLeft >= 0) {
                timerElement.textContent = `Thời gian: ${formatTime(timeLeft)}`;
            } else {
                clearInterval(timerInterval);
                handleNextButton();
            }
        ...
        function toggleDisplay(showSelector, hideSelector) {
            document.querySelector(showSelector).style.display = 'grid';
